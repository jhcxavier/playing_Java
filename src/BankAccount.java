public class BankAccount {
    ...
    public BankAccount(int account_number, int account_balance){
        ...
        System.out.println("You created account number: " + this.account_number +".");
    }
    public void deposit(int addMoney){
        if(addMoney < 0){
            System.out.println("You cannot depoist a " +
                    "negative amount");
        }else{
    ...
    public void withdraw(int removeMoney) {
        if (removeMoney > this.account_balance) {
            System.out.println("You cannot withdraw more that you balance");
        } else {
